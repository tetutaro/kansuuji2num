...
def main() -> None:
    parser = ArgumentParser(
        description='convert kansuji in given text to arabic numerals'
    )
    parser.add_argument(
        'text', type=str,
        help='text you want to convert'
    )
    parser.add_argument(
        '--chop-dai', action='store_true',
        help='chop "第" before kansuji from text'
    )
    args = parser.parse_args()
    print(kansuji2num(**vars(args)))
    return
